...
(defvar saved-windows-configuration nil)
...
(defun layout-save-current-vb ()
  (interactive)
  (setq saved-windows-configuration (current-window-configuration))
  (message "Windows layout saved."))

(defun layout-restore-vb ()
  (interactive)
  (if saved-windows-configuration
      (set-window-configuration saved-windows-configuration)
